...
/* WEBPACK VAR INJECTION */(function(jQuery) {function show_result(data, xhr) {
  console.log(xhr);
...
jQuery(function ($) {
  $("#arm_form").bind("ajax:success", function (data, xhr) {
    show_result(data, xhr);
  });
  console.log("Ok");
});
...
/******/ });
//# sourceMappingURL=application-abef5209ce58879aaadc.js.map