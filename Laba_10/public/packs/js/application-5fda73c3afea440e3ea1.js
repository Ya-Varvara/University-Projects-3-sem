...
/* WEBPACK VAR INJECTION */(function(jQuery) {function show_result(data) {
  ...
  console.log(data.originalEvent.detail[0].value[0]);
  result.innerHTML = data.originalEvent.detail[0].value.forEach(function (elem) {
    console.log(elem);
  }).join('<\br>');
}
...
/******/ });
//# sourceMappingURL=application-5fda73c3afea440e3ea1.js.map