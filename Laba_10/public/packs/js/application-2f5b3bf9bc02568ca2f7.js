...
/* WEBPACK VAR INJECTION */(function(jQuery) {function show_result(data) {
  ...
  result.innerHTML = "<br>"; // console.log(data)
  // console.log(data.originalEvent.detail[0].value.map(elem=>elem.join(':')))
  ...
  } else data.originalEvent.detail[0].value.forEach(function (elem) {
    result.innerHTML += elem.join(': ') + "<br>";
  });
}

jQuery(function ($) {
  $("#arm_form").bind("ajax:success", function (data) {
    show_result(data);
  });
  console.log("Ok");
});
...
/******/ });
//# sourceMappingURL=application-2f5b3bf9bc02568ca2f7.js.map