...
/* harmony import */ var _armstrongs_numbers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./armstrongs_numbers */ "./app/javascript/packs/armstrongs_numbers.js");
/* harmony import */ var _armstrongs_numbers__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_armstrongs_numbers__WEBPACK_IMPORTED_MODULE_4__);
...
/***/ "./app/javascript/packs/armstrongs_numbers.js":
/*!****************************************************!*\
  !*** ./app/javascript/packs/armstrongs_numbers.js ***!
  \****************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery) {function show_result(data, xhr, status) {
  console.log(xhr, status);
  var result = document.getElementById('result');
  result.innerHTML = "<br>"; // console.log(data.originalEvent.detail[0].value.map(elem=>elem.join(':')))
  // result.innerHTML += data.originalEvent.detail[0].value.map(elem=>elem.join(': ')).join('<br>')

  data.originalEvent.detail[0].value.forEach(function (elem) {
    result.innerHTML += elem.join(': ') + "<br>";
  });
}

jQuery(function ($) {
  $("#arm_form").bind("ajax:success", function (data, xhr, status) {
    show_result(data, xhr, status);
  });
  console.log("Ok");
});
...
/******/ });
//# sourceMappingURL=application-2e719416bfeadd8f6079.js.map