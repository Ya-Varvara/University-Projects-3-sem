...
/* WEBPACK VAR INJECTION */(function(jQuery) {function show_result(data) {
  ...
  result.innerHTML = "";
  if (typeof data.originalEvent.detail[0].value == 'string') result.innerHTML += data.originalEvent.detail[0].value;else data.originalEvent.detail[0].value.forEach(function (elem) {
    result.innerText += elem.join(': ') + "\n";
  });
}
...
/******/ });
//# sourceMappingURL=application-16eefa141fe6b2274565.js.map