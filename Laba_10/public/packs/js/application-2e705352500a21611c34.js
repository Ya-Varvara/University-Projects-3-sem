...
/* WEBPACK VAR INJECTION */(function(jQuery) {function show_result(data) {
  ...
  console.log(data.originalEvent.detail[0].value.map(function (elem) {
    elem.join(':');
  }));
  result.innerHTML += data.originalEvent.detail[0].value.map(function (elem) {
    elem.join(':');
  }).join('<br>');
}
...
/******/ });
//# sourceMappingURL=application-2e705352500a21611c34.js.map